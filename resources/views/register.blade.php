                            ...
                            <div class="row">
                                <div class="col-md-4 pe-md-0">
                                    <div class="auth-side-wrapper"
                                        style="background-image: url({{ asset('img/bg-login.jpg') }})"></div>
                                </div>
                                <div class="col-md-8 ps-md-0">
                                    <div class="auth-form-wrapper px-4 py-5">
                                        <a href="{{ route('login') }}"
                                            class="noble-ui-logo d-block mb-2">{{ config('app.name') }}</a>
                                        <h5 class="text-muted fw-normal mb-4">Isian ini harus terisi semua, pastikan
                                            username dan password <span class="text-danger">*</span> Diingat dan Dicatat
                                        </h5>
                                        <form action="{{ route('processRegister') }}" class="forms-group"
                                            ...
                                            @if (session('error') === '')
                                                <div class="alert alert-success">
                                                    Regitrasi akun berhasil<br>
                                                    Silakan login untuk melengkapi data peserta!
                                                </div>
                                            @endif

                                            <div class="mb-3">
                                                <label for="name" class="form-label text-muted">Nama Lengkap<span
                                            ...
                                            <a href="{{ route('login') }}" class="d-block mt-3 text-muted">Jika Sudah
