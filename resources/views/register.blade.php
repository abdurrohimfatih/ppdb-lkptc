                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 ps-md-0">
                                <div class="auth-form-wrapper px-4 py-5">
                                    ...
                                    <h5 class="text-muted fw-normal mb-4">Isian ini harus terisi semua, pastikan username dan password <span class="text-danger">*</span> Diingat dan Dicatat</h5>
                                    <form action="{{route('processRegister')}}" class="forms-group" method="post">
                                        ...
                                        <div class="mb-3">
                                            <label for="name" class="form-label text-muted">Nama Lengkap<span class="text-danger">*</span></label>
                                        ...
                                        <a href="{{route('login')}}" class="d-block mt-3 text-muted">Jika Sudah Punya Akun? Login disini</a>
                                    </form>
                                </div>
                            </div>
                        </div>
