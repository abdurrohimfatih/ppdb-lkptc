            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if (\Illuminate\Support\Facades\Auth::user()->level >= 2)
                        <h6 class="card-title"><b>Prestasi Pendaftar</b></h6>
                                            ...
                                            @if ($u->prestasi->isNotEmpty())
                                                @foreach ($u->prestasi as $p)
                                                    @if (count($u->prestasi) >= 1)
                                                        ...
                                                        @for ($i = 0; $i < 3 - count($u->prestasi); $i++)
                                                            <td>-</td>
                                                        @endfor
                                                    @endif
                                                @endforeach
                            ...
                            <form action="{{ route('storePrestasi') }}" method="POST">
                                ...
                                @elseif(session('error') == 2)
                                    <div class="mt-2 alert alert-warning">
                                        <i class="link-icon" data-feather="alert-circle"></i> Masukkan prestasi dan juga
                                        tingkatnya!
                                    </div>
                                @endif
