...
<!--                            </div>-->
                        ...
                        <div class="mb-3 mt-1">
                            <label for="no_telp" class="form-label text-muted">No Telepon / WA<span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="no_telp" id="no_telp" placeholder="Masukkan No Telp/WA anda" value="{{$biodata->no_telp??null}}">
                        </div>
                        ...
                        <div class="mb-3 mt-1">
                            <label for="status_perkawinan" class="form-label text-muted">Status Perkawinan (Tulis Salah Satu)</label>
                            <input type="text" class="form-control" name="status_perkawinan" id="status_perkawinan" placeholder="Belum Kawin / Kawin / Duda / Janda" value="{{$biodata->status_perkawinan??null}}">
                        </div>
                        ...
                        <div class="mb-3 mt-1">
                            ...
                            <input type="text" class="form-control" name="anak_ke" id="anak_ke" placeholder="Anak ke" value="{{$biodata->anak_ke??null}}">
                        </div>

                        <div class="mb-3 mt-1">
                            <label for="jumlah_saudara" class="form-label text-muted">Jumlah Saudara</label>
                            <input type="text" class="form-control" name="jumlah_saudara" id="jumlah_saudara" placeholder="jumlah saudara" value="{{$biodata->jumlah_saudara??null}}">
                        </div>
