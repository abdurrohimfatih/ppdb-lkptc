            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if (\Illuminate\Support\Facades\Auth::user()->level >= 2)
                        <h6 class="card-title"><b>Nilai Pendaftar</b></h6>
                    ...
                    @elseif(\Illuminate\Support\Facades\Auth::user()->level == 1)
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p>Silahkan isi nilai sesuai dengan mata pelajaran masing-masing!</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <form action="{{ route('storePostNilai') }}" method="POST">
                                ...
                                <div class="table-responsive pt-3">
                                    <table class="table table-bordered table-responsive-sm mb-3">
                                        <thead>
                                            <tr>
                                                <th rowspan="2">No</th>
                                                <th rowspan="2">Mata Pelajaran</th>
                                                <th colspan="6" class="text-center">Data Nilai</th>
                                            </tr>
                                            <tr>
                                                <th>Semester 1</th>
                                                <th>Semester 2</th>
